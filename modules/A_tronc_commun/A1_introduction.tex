...
\begin{frame}{Plan du cours}
  Ce cours nécessite 3 notions clés de mathématiques:
  \begin{itemize}
  ...
  \end{itemize}
  ~\\
  Notre cours évitera le plus possible les nombres complexes afin de simplifier le sujet.\\~\\
  L'offre est divisée en:
  \begin{itemize}
    \item \textbf{Modules de base} (A et B): tronc commun sans nombres complexes
