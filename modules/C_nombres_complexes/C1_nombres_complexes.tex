...
\title[Module C1]{Module C1: Introduction aux nombres complexes}
...
\begin{frame}{Multiplication par $1+i$}
  ...
  \begin{tikzpicture}[scale=1.3]
    ...
    \draw[->,thick,red] (0,0) -- (1,3) node[right] {$z+iz$};
...
\begin{frame}{Module et phase}
  ...
  La \textbf{phase} (ou argument) est l'angle $\theta$ que fait le vecteur avec l'axe réel.
\end{frame}
...
\begin{frame}{Interprétation trigonométrique}
  ...
  \begin{columns}[T]
    ...
    \begin{column}{0.49\textwidth}
      ...
      \textbf{Normalisation} pour garder la \\
      rotation uniquement:
...
\begin{frame}{Vidéos par 3Blue1Brown} 
  \begin{center}
    \includegraphics[width=\linewidth]{3b1b_complexes.png}
  \end{center}
\end{frame}
