...
\title[Module D2]{Module D2: Les inégalités de Bell}
...
\begin{frame}{Paradoxe EPR: Situation}
  \begin{columns}[T]
    ...
    \begin{column}{0.4\textwidth}
      \centering
      \includegraphics[width=\linewidth]{epr.png}
    \end{column}
  \end{columns}
\end{frame}
...
\begin{frame}{Test statistique (CHSH)}
  \begin{columns}[T]
    ...
    \begin{column}{0.4\textwidth}
      \centering
      \includegraphics[width=\linewidth]{chsh.png}
    \end{column}
  \end{columns}
\end{frame}
...
\begin{frame}{Les expériences d'Alain Aspect (1982)}
  ...
  \begin{center}
    \includegraphics[width=0.7\linewidth]{aspect1.png}
  \end{center}
\end{frame}
...
\begin{frame}{Mise en place du test CHSH}
  ...
  \begin{center}
    \includegraphics[width=0.7\linewidth]{aspect2.png}
  \end{center}
\end{frame}
...
\begin{frame}{Interrupteur optique}
  ...
  \begin{center}
    \includegraphics[width=0.7\linewidth]{aspect3.png}
  \end{center}
\end{frame}
...
\begin{frame}{Vidéos sur le sujet}
  \begin{center}
    \includegraphics[width=\linewidth]{scienceetonnante.png}
  \end{center}
\end{frame}
