...
\title[Module D1]{Module D1: Plateformes implémentant des ordinateurs quantiques}
...
\begin{itemize}
    ...
    \]
    \item Le composant de base est le \textbf{transistor}:
    \begin{itemize}
        \item canal ouvert = 1,
        \item canal fermé = 0.
    \end{itemize}
...
% ============================================================
\section{Plateformes quantiques}
% ============================================================
...
\centering
\begin{tikzpicture}
    \node[inner sep=0] (img) {\includegraphics[width=0.8\linewidth]{qubit_SC.png}};
...
\begin{column}{0.4\textwidth}
\centering
\includegraphics[width=0.8\linewidth]{ion_trap.jpg}
\end{column}
\end{columns}
\end{frame}
...
\begin{column}{0.4\textwidth}
\centering
\includegraphics[width=0.8\linewidth]{atomes_neutres.png}
\end{column}
\end{columns}
\end{frame}

\begin{frame}{Autres plateformes}
    \centering
 D'autres plateformes existent: Spins dans les semi-conducteurs et photonique.
\end{frame}
