...
\begin{frame}{The Qubit in all its states}
    \begin{columns}[T]
    ...
    \begin{column}{0.49\textwidth}
    \begin{itemize}
        \item Until now, we have described the qubit as a linear superposition of states without specifying the nature of the coefficients $\alpha$ and $\beta$.
        \begin{equation*}
        ...
        \begin{equation*}
            1 = |\alpha|^{2} + |\beta|^{2}
        \end{equation*}
        \item With real numbers, we have:
        \begin{equation*}
...
\begin{frame}{The Qubit in all its states}
    \begin{itemize}
        \item In reality, these coefficients can have complex phases:
        \begin{equation*}
            \ket{\psi} = \alpha e^{i\phi_A} \ket{0} + \beta e^{i\phi_B} \ket{1}
        \end{equation*}
        \item Since quantum states are identical up to a multiplicative constant, we can choose to eliminate the global phase $e^{i\phi_A}$:
        \begin{equation*}
            \ket{\psi} = \alpha \ket{0} + e^{i\phi_B - \phi_A}\beta \ket{1}
        \end{equation*}
        \item The general expression of a qubit is therefore:
        \begin{equation*}
...
\begin{frame}{The Qubit in all its states}
    ...
    \begin{column}{0.64\textwidth}
        \begin{itemize}
            \item The convention is to write the general state of a qubit as:
            \begin{equation*}
            \boxed{
                \ket{\psi} = \cos\left(\frac{\theta}{2}\right) \ket{0} + e^{i\phi}\sin\left(\frac{\theta}{2}\right) \ket{1}
            }
            \end{equation*}
            \\~\\~
            \item Due to the visualization on the \textit{Bloch sphere}.
        \end{itemize}
    \end{column}
    \end{columns}
\end{frame}

\begin{frame}{Consequences for "bra" vectors}
    \begin{itemize}
        \item If a qubit is now written with complex numbers $\alpha,\beta\in\mathbb{C}$:
        \begin{equation*}
            \ket{\psi} = \alpha \ket{0} + \beta \ket{1}
        \end{equation*}

        %\vspace{5mm}
        \item Then the "bra" must be written with the complex conjugate coefficients:
        \begin{equation*}
            \bra{\psi} = \alpha^* \bra{0} + \beta^* \bra{1}
        \end{equation*}

        %\vspace{5mm}
        \item So as to preserve a real number for the norm: 
        \begin{align*}
            1 = \braket{\psi}{\psi} 
...
\begin{frame}{Consequences for matrices}
    \begin{itemize}   
        \item Regarding matrices,
        \begin{equation*}
        ...
        %\vspace{5mm}
        \item It is necessary that the matrix reproducing the operation on the "bra" also has conjugate coefficients, in addition to being transposed relative to the diagonal:
        \begin{equation*}
