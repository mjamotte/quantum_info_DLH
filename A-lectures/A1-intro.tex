...
\begin{frame}{Fundamental differences between classical and quantum computers}
  ...
  \begin{tabular}{l|c|c}
    ...
    & Discrete & Continuous \\
     ~& ~ & ~\\
    Mathematical description & Booleans (0/1) & Vectors/Matrices \\
    ~& ~ & ~\\
...
\begin{frame}{Usefulness despite this limitation}
  \begin{itemize}
    \item {\bf Grover's algorithm:} Quadratic speedup for solving a problem for which it is easy to recognize a solution. Applications: searching an element in an unstructured database, inverting a hash function, ... \\~\\
