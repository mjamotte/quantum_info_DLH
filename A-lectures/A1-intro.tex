...
\begin{frame}{Utilité malgré cette limitation}
  \begin{itemize}
    \item {\bf Algorithme de Grover:} Accélération quadratique pour la recherche de solution à une fonction "boîte noire". Applications: chercher un élément dans une base de données non-structurée, inverser une fonction de hachage, résolution d'un problème NP-complet, ... \\~\\
