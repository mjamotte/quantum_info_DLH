...
\begin{frame}{Stabilité de l'atome}
  \begin{itemize}[<+->]
    ...
    \item Mécanique quantique: niveau d'énergie minimale stable + niveaux d'énergie quantifiés: modèle de Bohr.\\~\\
...
\begin{frame}{Raies spectrales}
  \begin{itemize}[<+->]
    \item Spectre d'émission du soleil (Fraunhofer).
    \begin{figure}
      \includegraphics[width=0.6\linewidth]{figures/Fraunhofer_lines.png}
    \end{figure}
    \item Raies sombres dues à l'absorption des gaz dans le soleil et de notre atmosphère (Bunsen et Kirchhoff).
    \\~\\
    \item Les raies spectrales signent ces sauts discrets entre orbitales (Bohr).
  \end{itemize}
\end{frame}

\begin{frame}{Diffraction d'électrons (fentes de Young)}
  \begin{itemize}
...
\begin{frame}{Diffraction d'électrons (fentes de Young)}
  \begin{itemize}[<+->]
    ...
    \end{figure}
    \item Même envoyés un par un, le motif d'interférence apparaît -- comme pour les ondes lumineuses!
...
\begin{frame}{Expérience de Stern-Gerlach}
  \begin{itemize}[<+->]
