...
\begin{frame}{Utilité malgré cette limitation}
  \begin{itemize}
    \item Algorithme de Groover\\~\\
    \item Algorithme de Shor\\~\\
    \item Algorithme hybride d'optimisation (QAOA, VQE,...)
  \end{itemize}
\end{frame}
