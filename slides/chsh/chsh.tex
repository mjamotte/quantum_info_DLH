...
\begin{frame}{Paradoxe EPR}
  \begin{columns}[T]
    \begin{column}{0.55\textwidth}
      ...
      \]
      conduisent à des corrélations qui suggèrent une action à distance instantanée.
    \end{column}
...
\begin{frame}{Variables cachées}
  ...
  \bigskip
  Il n'y aurait pas de superposition d'états, mais simplement des états dont nous ne connaissons pas la nature exacte.
...
\begin{frame}{Violation quantique (suite)}
  ...
  Et la combinaison $S = 2\sqrt{2} \approx 2.83 > 2$
\end{frame}
